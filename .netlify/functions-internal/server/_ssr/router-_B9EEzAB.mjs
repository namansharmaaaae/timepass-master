...
const appCss = "/assets/styles-ot43kvDC.css";
...
const $$splitComponentImporter = () => import("./index-CcVrgr4R.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A small interactive love letter celebrating nine months together — timelines, memories, quizzes, and dreams ahead."
    }, {
      property: "og:title",
      content: "Happy 9 months NIHARIKA"
    }, {
